                ...
                <div class="card detail-card mb-4">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2 class="h4 mb-0">
                                <i class="bi bi-box-seam"></i> <?php echo e($product->name); ?>

                            </h2>
                            <div>
                                <span class="badge bg-success info-badge">$<?php echo e(number_format($product->price, 2)); ?></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <p class="mt-3"><?php echo e($product->description ?? 'No description available'); ?></p>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="mt-3">
                                            <span class="badge bg-<?php echo e($product->stock > 0 ? 'info' : 'warning'); ?> info-badge">
                                                <?php echo e($product->stock); ?> units available
                                            </span>
                                        </div>
                                    </div>
                    ...
                    <div class="card-footer bg-light">
                        <div class="d-flex justify-content-between">
                            <small class="text-muted">
                                Created: <?php echo e($product->created_at->format('M d, Y')); ?>

                            </small>
                            <small class="text-muted">
                                Last Updated: <?php echo e($product->updated_at->format('M d, Y')); ?>
...
</html><?php /**PATH D:\A6 Year3\Web y3\liquorStore\resources\views/products/show.blade.php ENDPATH**/ ?>